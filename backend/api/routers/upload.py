...
UPLOAD_CHUNK_SIZE = settings.UPLOAD_CHUNK_SIZE_MB * 1024 * 1024
ALLOWED_UPLOAD_EXTENSIONS = set(settings.UPLOAD_ALLOWED_EXTENSIONS)
EXCEL_OLE_SIGNATURE = b"\xD0\xCF\x11\xE0\xA1\xB1\x1A\xE1"
XLSX_REQUIRED_MEMBERS = {"[Content_Types].xml", "xl/workbook.xml"}
MAX_XLSX_ZIP_ENTRIES = settings.MAX_XLSX_ZIP_ENTRIES
MAX_XLSX_TOTAL_UNCOMPRESSED_BYTES = settings.MAX_XLSX_TOTAL_UNCOMPRESSED_MB * 1024 * 1024
MAX_XLSX_ENTRY_UNCOMPRESSED_BYTES = settings.MAX_XLSX_ENTRY_UNCOMPRESSED_MB * 1024 * 1024
MAX_XLSX_COMPRESSION_RATIO = settings.MAX_XLSX_COMPRESSION_RATIO
