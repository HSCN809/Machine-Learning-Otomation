...
import { buildLoginHref, buildSignupHref, DEFAULT_AUTHENTICATED_PATH } from '@/lib/routing';
    ...
    useEffect(() => {
        ...
        async function verifyAuth() {
            try {
                ...
                router.replace(status.requires_setup ? buildSignupHref(nextPath) : buildLoginHref(nextPath));
            } catch (error) {
                if (cancelled) {
                    return;
                }
